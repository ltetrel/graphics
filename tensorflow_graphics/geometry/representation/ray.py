...
def stratified_sampling(ray_org: TensorLike,
                        ray_dir: TensorLike,
                        near: float,
                        far: float,
                        n_samples: int,
...
def inverse_transform_stratified(ray_org: TensorLike,
                                 ray_dir: TensorLike,
  ...
  Args:
    ...
    n_samples: A number M to sample on the ray.
    combine_z_values: Weather to combine the new 1D samples with
      the initial points.
    name: A name for this op that defaults to "stratified_sampling".
